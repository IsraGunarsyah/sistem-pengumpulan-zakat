...
<div id="sidebar" class="w-64 bg-green-600 h-screen fixed top-0 left-0 text-slate-700 transform -translate-x-full md:translate-x-0 transition-transform duration-200 ease-in-out z-50 shadow-lg">
    ...
    <div class="p-4 bg-green-600 mt-4 rounded-lg shadow-md flex items-center space-x-4">
        ...
        <div class="text-white">
            ...
            <p class="text-xs text-gray-200">User</p>
        </div>
    </div>
        ...
        <ul class="flex flex-col pl-4 mb-0 space-y-4">
            ...
            <li class="mt-1 w-full">
                <a href="{{ route('user.index') }}"
                   class="flex items-center text-base font-semibold p-2 rounded-md {{ request()->is('user/dashboard') ? 'bg-green-800 text-white' : 'hover:bg-green-400 hover:text-white ' }} transition-all">
            ...
            <li class="mt-0.5 w-full">
                <a href="{{ route('user.map-upz') }}"
                   class="flex items-center text-base font-semibold p-2 rounded-md {{ request()->is('user/map') ? 'bg-green-800 text-white' : 'hover:bg-green-400 hover:text-white ' }} transition-all">
